...
const APP_STORE_FRONTENDS_PATH = fileURLToPath(
  new URL("../../overrides/app-store-frontends.ndjson", import.meta.url),
);
...
/** Loads the hand-curated app-store/package-manager frontend list (`overrides/app-store-frontends.ndjson`, missing file reads as empty). */
