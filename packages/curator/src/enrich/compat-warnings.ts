...
const COMPAT_WARNINGS_PATH = fileURLToPath(
  new URL("../../overrides/compat-warnings.ndjson", import.meta.url),
);
...
/** Loads the hand-curated compatibility-warning list (`overrides/compat-warnings.ndjson`, missing file reads as empty). */
