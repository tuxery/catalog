...
const SUITES_PATH = fileURLToPath(new URL("../../overrides/suites.ndjson", import.meta.url));
...
/** Loads the hand-curated suite list (`overrides/suites.ndjson`, missing file reads as empty). */
