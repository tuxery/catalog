 ...
 * same depth under `src/` as every per-source folder, so
 * `../../cache/<name>.ndjson` lands in the identical place
 * (`packages/sources/cache/`) no matter which one computes it.
 */
