...
const KEEP_PATH = fileURLToPath(new URL("../../../config/overrides/keep.ndjson", import.meta.url));
const EXCLUDE_PATH = fileURLToPath(
  new URL("../../../config/overrides/exclude.ndjson", import.meta.url),
);
